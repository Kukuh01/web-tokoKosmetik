...
<main className="relative mx-auto flex min-h-screen max-w-[640px] flex-col gap-5 bg-[#F6F6F8] pb-[48px]">
  <div id="Background" className="absolute top-0 left-0 right-0">
    <img
      ...
      <div id="ProgressBar" className="relative px-[12px]">
        <div className="flex">
          ...
          <div className="relative flex h-[25px] w-full items-center">
            <div className="left-0 w-1/2 h-2 rounded-full bg-cosmetics-purple" />
            ...
            <div className="right-0 w-1/2 h-2 rounded-full bg-cosmetics-purple" />
          </div>
